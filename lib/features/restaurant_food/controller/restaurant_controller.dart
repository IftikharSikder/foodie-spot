...
//   Food? _selectedFood;
//
//   // New properties for sorting and tab selection
...
//   }
//
//   // New method to set sort option
//   void setSortOption(String option) {
//     _selectedSortOption = option;
//     notifyListeners();
//   }
//
//   // New method to set selected tab
//   void setSelectedTab(String tab) {
//     _selectedTab = tab;
//     notifyListeners();
//   }
//
//   // New method to get sorted restaurants
...
class RestaurantController extends ChangeNotifier {
  ...
  // Modified method to set sort option
  void setSortOption(String option) {
    _selectedSortOption = option;
    notifyListeners();
  }
  ...
  // Modified method to get sorted restaurants
  List<Restaurant> getSortedRestaurants() {
    List<Restaurant> restaurantsToSort = _isSearching
        ? _filteredRestaurants
        : _restaurants;
  ...
  // NEW METHOD: Get foods from sorted restaurants
  ...
  // NEW METHOD: Get restaurant info for a specific food
